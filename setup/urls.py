...
from base.views import home, shopping_cart, cadastro, busca, add_to_cart, remove_from_cart, edicao, checkout, create_product
...
urlpatterns = [
 path('admin/', admin.site.urls),
    ...
    path("produto/editar/<int:product_id>/", edicao, name="edit_product"),
]
